...
fn bench_p1_swift(c: &mut Criterion) {
    ...
    g.bench_function("part1_swift", |b| {
        b.iter_batched(
            ...
            |mut f| day11::swift::part1_swift(&mut f),
            BatchSize::SmallInput,
        )
    });
    g.finish()
...
criterion_group!(benches, bench_p1, bench_p1_uncle_scientist, bench_p2, bench_p2_uncle_scientist);
#[cfg(feature="Swift")]
criterion_group!(benches, bench_p1, bench_p1_uncle_scientist, bench_p1_swift, bench_p2, bench_p2_uncle_scientist);
